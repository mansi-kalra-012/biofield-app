  ...
  return (
    <div>
      <div className={styles.mainC}>
        <Header text="Farmer" />
        <img src='/images/motoImg.png' alt="" className={styles.image1} />
        <div className={styles.container}>
        <div className={styles.text1}>Current STATE OF <br/>THE 
        PUMP</div>
        <img src='/images/motoImg.png' alt="" className={styles.image2} />
        </div>
        <div className={styles.text2}>TURN ON TIME</div>
        <div className={styles.container2}>
        <div className={styles.texxt}>8:00 AM</div>
        <img src='/images/Clock.png' alt="" className={styles.image2} />
        </div>
      </div>
    </div>
  )
